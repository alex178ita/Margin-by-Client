 ...
 */
export function linkProjectsToDeals(projects, deals) {
...
export function assemble(invoices, projects, costs, deals, errors, opts) {
  ...
  const missingCrmid = projRows.filter((p) => (p.k === "client" || p.k === "client_mgmt") && !p.crmid);
  return {
...
export async function buildSnapshot() {
  ...
  projects = linkProjectsToDeals(projects, deals);
