 ...
 *
 * Il perimetro è questo: restano ricavi, margine e percentuali — il valore di
 * un deal non è un segreto, e il peso di un cliente nemmeno. Sparisce il
 * dettaglio per persona, che è l'unico punto in cui una tariffa individuale si
 * legge in chiaro.
 *
 * Va detto senza girarci intorno: chi vede ricavo e margine ricava il costo
 * totale del team con una sottrazione, e diviso per le ore ottiene la tariffa
 * media. Quello che resta protetto è chi ha lavorato e quanto costa ciascuno —
 * salvo sui progetti a una persona sola, dove media e individuale coincidono.
 */
